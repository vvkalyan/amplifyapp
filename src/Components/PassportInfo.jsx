...
const PassportInfo = () => {
	const validateEvent = (e) => {
		var x = document.getElementById('dateofissue').value;
		var y = document.getElementById('dateofexpiry').value;
		if (y < x) {
			var el = (document.getElementById('labelexpiry').innerHTML =
				'* Please enter expiry before issue date');
			e.preventDefault();
			// alert("Please enter expiry before issue date")
			el.remove();
		}
		el.remove();
		console.log(x);
	...
	return (
		<>
			<form
				...
				id='pills-passportInfo'
				role='tabpanel'
				aria-labelledby='pills-passportInfo-tab'
			>
				...
				<div className='row position-relative'>
					...
					<div className='form-group col-12 col-sm-6'>
						<label for='dateofexpiry' id='labelexpiry'>
							Date of Expiry
						</label>
						<input
							id='dateofexpiry'
					...
					<div className='form-group col-12 col-sm-6'>
						<label for='passportcountry'>Country</label>
						{/* <!-- <input id="passportcountry" name="passportcountry" type="text" className="form-control" required> --> */}
						<select
							id='passportcountry'
